...
const PackageCard = ({
  ...
  return (
    <Link
      href={`${href}`}
      className="flex flex-col h-[500px] rounded-lg overflow-hidden bg-[#EDEAEA] p-4"
    >
      ...
      <div className="flex flex-col flex-grow justify-between p-4">
        ...
        <p className="text-gray max-w-[700px] text-lg leading-8 font-sfproLight">
          {details}
        </p>
        <hr className="border-gray-300 my-4" />
        <div className="flex items-center justify-between">
          <div>
            <p className="text-md font-bold font-modicaMedium">
              Starting From:
            </p>
      ...
      <div className="flex items-center justify-between pl-4 pr-2">
        <button className="bg-green-600 text-md font-bold text-white px-4 py-2 hover:bg-green-700 transition duration-300">
          Book Now
        </button>
