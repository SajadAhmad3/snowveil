  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-10 lg:top-0 left-0 items-center justify-center text-white text-center flex flex-col h-full w-full px-4 gap-2">
        ...
        <button className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 lg:mt-4 rounded-full lg:text-md md:text-sm text-xs transition duration-300 font-bold">
          Book A Trip
        </button>
      </div>
    </div>
